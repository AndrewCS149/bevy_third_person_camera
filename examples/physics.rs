/*
Example displaying the integration with a third party physics engine. In this case Bevy Avian 3d
The key is to run the CameraSyncSet AFTER the PhysicsSet, see line 14.
*/
